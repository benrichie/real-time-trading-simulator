...
If the demo requests fail, open the backend link first to wake it and after loaded, refresh the frontend. Scheduled background updates (e.g., price and order checks) pause while the backend sleeps.
